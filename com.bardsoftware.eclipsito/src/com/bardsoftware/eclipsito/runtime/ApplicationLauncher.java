...
public class ApplicationLauncher {
    ...
    static final PluginDescriptor.ExtensionPointDescriptor ourRuntimeApplicationExtensionPoint =
        new PluginDescriptor.ExtensionPointDescriptor(IModel.PI_APPLICATIONS, IModel.PI_RUNTIME, null, null);
