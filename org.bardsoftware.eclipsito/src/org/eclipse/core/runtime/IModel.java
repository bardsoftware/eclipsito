...
public interface IModel {
	...
	public static final String PI_APPLICATIONS = "applications"; //$NON-NLS-1$
	public static final String PI_APP = "application"; //$NON-NLS-1$
	public static final String PI_RUN = "run"; //$NON-NLS-1$
